...
function SessionModal({ workspace, onClose, onSave, busy }) {
  ...
  function submit(event) { event.preventDefault(); onSave({ engagement_id: workspace.engagement.id, brand_id: workspace.engagement.brand_id, engagement_stage_instance_id: bestStage(workspace.stages, 'design')?.id || null, engagement_service_id: serviceId, external_event_id: externalEventId || null, flow_id: flowId || null, page_slug: flowId ? pageSlug : null, output_brief: { goal, required_format: format }, designer_instructions: instructions, instructions_safe_for_ai: safe, model_registry_ids: modelIds }) }
