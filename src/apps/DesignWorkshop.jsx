...
function WorkshopWorkspace({ workspace, assetLibraryContextKey, focusedSessionId, focusedVersionId: navigationFocusedVersionId, focusedDraftId, canUploadAsset, onUploadAsset, canPromoteExperiment, onCreateFlow, onCreate, onGenerate, onGenerateImage, onRefreshImageJob, onRetryImageJob, onGenerateVariants, onGenerateVideo, onGeneratePage, onSubmitPage, onApprovePage, onExportPage, onDownloadExport, onPrepareHandoff, onDownloadHandoff, onRefine, onPromote, onSetWorking, onSelect, onRelease, busy }) {
  ...
  return <div className="mt-6 space-y-6">
    ...
    {assetLibraryOpen && <DesignAssetLibrary key={contextKey} contextKey={contextKey} workspace={workspace} canUpload={canUploadAsset} busy={busy === 'asset-upload'} onUpload={onUploadAsset} onClose={() => setAssetLibraryOpen(false)} onFocusSource={focusAssetSource} />}
