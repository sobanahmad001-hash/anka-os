...
function WorkshopWorkspace({ workspace, focusedSessionId, focusedVersionId, focusedDraftId, canPromoteExperiment, onCreateFlow, onCreate, onGenerate, onGenerateImage, onGenerateVariants, onGenerateVideo, onGeneratePage, onSubmitPage, onApprovePage, onExportPage, onDownloadExport, onPrepareHandoff, onDownloadHandoff, onRefine, onPromote, onSetWorking, onSelect, onRelease, busy }) {
...
function DirectionCard({ direction, versions, version, models, mediaAssets, storyboard, working, selected, released, onGenerateImage, onGenerateVideo, onRefine, onSetWorking, onSelect, canSelect, busy }) {
