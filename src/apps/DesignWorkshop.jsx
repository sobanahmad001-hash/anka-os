...
function WorkshopWorkspace({ workspace, assetLibraryContextKey, focusedSessionId, focusedVersionId: navigationFocusedVersionId, focusedDraftId, canUploadAsset, onUploadAsset, canArchiveAsset, onArchiveAsset, onRefreshAssetLinks, canPromoteExperiment, onCreateFlow, onCreate, onGenerate, onGenerateImage, onRefreshImageJob, onRetryImageJob, onGenerateVariants, onGenerateVideo, onGeneratePage, onSubmitPage, onApprovePage, onExportPage, onDownloadExport, canPrepareHandoff, handoffUncertainTargets, handoffContext, onPrepareHandoff, onDownloadHandoff, onRefreshHandoffs, onRefine, onPromote, onSetWorking, onSelect, onRelease, busy }) {
  ...
  return <div className="mt-6 space-y-6">
    ...
    {assetLibraryOpen && <DesignAssetLibrary key={contextKey} contextKey={contextKey} workspace={workspace} canUpload={canUploadAsset} canArchive={canArchiveAsset} busy={busy === 'asset-upload' || busy.startsWith('asset-archive-')} onUpload={onUploadAsset} onArchive={onArchiveAsset} onRefresh={onRefreshAssetLinks} onClose={() => setAssetLibraryOpen(false)} onFocusSource={focusAssetSource} />}
