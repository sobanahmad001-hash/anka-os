...
export default function WorkItemsPanel({ workspace, owners, onRefresh }) {
  ...
  return <section className="mt-7 space-y-5">
    ...
    </div> : <WorkItemsBoard columns={boardColumns} relations={relations} owners={owners} artifacts={workspace.workItemArtifacts || []} loading={loading} moving={moving} draggedItemId={draggedItemId} onDragStart={setDraggedItemId} onMove={moveWorkItem} onMoveWithinColumn={moveWithinColumn} onOpen={item => { setDependencyCandidate(''); setEditor({ ...item }) }} />}
