...
function CalendarCard({ entry, compact = false }) {
  const tone = entry.calendarState === 'draft' ? 'bg-amber-950 text-amber-200' : entry.calendarState === 'completed' ? 'bg-blue-950 text-blue-200' : 'bg-emerald-950 text-emerald-200'
