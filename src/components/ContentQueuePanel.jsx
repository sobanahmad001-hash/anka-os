...
export default function ContentQueuePanel({ repository }) {
  ...
  async function create(event) {
    ...
    await run(() => repository.create(serializeContentQueueEntry(form)), 'Queue plan added. No content request has been created.')
