...
export default function Login() {
  ...
  return (
    <div style={{
      ...
      background: '#020617', color: '#f8fafc', position: 'relative', overflow: 'hidden',
    }}>
      ...
      <div className="anka-fade-in" style={{ position: 'relative', zIndex: 1, width: '100%', maxWidth: 420, margin: '0 24px' }}>
        ...
        <div className="anka-glass-heavy" style={{
          ...
          <h2 style={{ color: '#f8fafc', fontSize: 20, fontWeight: 600, marginBottom: 28, letterSpacing: '-0.02em' }}>
            Welcome back
          </h2>
          ...
          {error && (
            <div style={{
              ...
              background: 'rgba(127, 29, 29, 0.35)', border: '1px solid rgba(248, 113, 113, 0.3)',
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
            <div>
              ...
              <input
                ...
                className="placeholder:text-slate-500" style={inputStyle} placeholder="you@ankastudio.com"
                onFocus={(e) => { e.target.style.borderColor = '#818cf8'; e.target.style.boxShadow = '0 0 0 3px rgba(99, 102, 241, 0.22)'; }}
            ...
            <div>
              ...
              <input
                ...
                className="placeholder:text-slate-500" style={inputStyle} placeholder="••••••••"
                onFocus={(e) => { e.target.style.borderColor = '#818cf8'; e.target.style.boxShadow = '0 0 0 3px rgba(99, 102, 241, 0.22)'; }}
                onBlur={(e) => { e.target.style.borderColor = '#334155'; e.target.style.boxShadow = 'none'; }}
              />
            </div>
