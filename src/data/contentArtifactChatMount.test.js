...
const data = (org, project, id) => ({ engagement: { id, organization_id: org, project_id: project, brand_id: 'brand' },
  contentServices: [{ id: 'service', organization_id: org, engagement_id: id, status: 'active', service_catalog: { department_id: 'content', is_active: true } }], artifacts: [], stages: [], versions: [] })
test('mounted Content adapter retains conversation callbacks and disables drafting for loading, denied, late and aborted reads', async t => {
