...
test('workspace routes and terminology expose portfolio alongside dedicated WKS4 internal work', () => {
  ...
  assert.match(app, /path="sphere\/workspace" element={<WorkspaceHome \/>}/)
  ...
  for (const term of ['Workspace', 'Home', 'Projects', 'Clients']) assert.match(nav, new RegExp(term))
  assert.match(view, /Internal Work/)
