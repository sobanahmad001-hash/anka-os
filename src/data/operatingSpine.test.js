...
test('Engagement workspace renders a pipeline tab and read-only entry points', () => {
  ...
  assert.match(operatingSpineView, /to=\{`\/sphere\/content\/studio\?engagement=\$\{engagementId\}\}/)
  assert.match(operatingSpineView, /to=\{`\/sphere\/design\/workshop\?engagement=\$\{engagementId\}\}/)
  assert.match(operatingSpineView, /to=\{`\/sphere\/engagements\?engagement=\$\{engagementId\}&tab=work\}/)
