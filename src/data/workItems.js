...
export function artifactRoute(artifactType) {
  ...
  if (['campaign_messaging', 'scripts', 'channel_strategy', 'campaign_brief', 'measurement_plan', 'marketing_report', 'seo_research'].includes(artifactType)) return '/sphere/marketing/studio'
